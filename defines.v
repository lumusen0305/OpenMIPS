...
`define InstMemNum 131071   //32*32
`define InstMemNumLog2 17


//ͨregfile defindes
`define RegAddrBus 4:0//ͨregfile address width 2**5
`define RegBus 31:0//ͨregfile data width
`define RegWidth 32//ͨregfile data width
...
`define DivStop 1'b0
//RAM defindes
`define DataAddrBus 31:0//length of  DataAddrBus
`define DataBus 31:0    //length of  DataBus
